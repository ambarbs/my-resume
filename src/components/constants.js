    ...
    },
    {
        ...
        subSections: [{
            ...
            },
            {
                ...
                subSectionTexts: ['Own, maintain and develop new features on existing Angular App (Angular 1.6)']
            },
            {
                ...
                subSectionTexts: ['Primary responsibilities are to develop new features using React, Redux (Matcher) using Micro-frontend architecture.']
            },
            {
                ...
                subSectionTexts: ['Developed new features using React, Redux, Sass with Tailwind', "Redesigned the the web app's home page with dynamically configurable layouts", 'Worked on SEO using AWS Lambdas', 'Developed multiple Lambdas for middle-layer using AWS AppSync and Node JS', 'Developed (both FE and BE) an interactive dashboard app to display and debug the discrepencies between old and new CMS', 'Developed Lambdas to dynamically generated sitemaps for Google News']
            },
            {
                ...
                subSectionTexts: ['Develop new features in the React and React Native Apps along with Java in the backend.',
            ...
            },
            {
                ...
                subSectionTexts: ['Develop new features in the React App and Middleware services running in Node']
            },
            {
                subSectionTitle: 'NBN',
                ...
                subSectionTexts: ['Won Hackathon event to develop an app showing the product road-map with rich features based on an excel-sheet input.', 'Integrated selenium with CI build system.']
            },
            {
            ...
            },
            {
                ...
                subSectionTexts: ['Successfully changed theme of the product, single-handedly and delivered before deadline without any prior knowledge of JavaScript/CSS',
